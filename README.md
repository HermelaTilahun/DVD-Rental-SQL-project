...
2. Delete a Rental Record: Delete a rental record from the rental table by specifying the rental ID.
3. Increase Film Rental Duration: Update the rental duration of a specific film in the film table, increasing it by 2 days.
4. Insert a New Film Record: Insert a new film with appropriate details (e.g., title, description, rental rate, length) into the film table.
